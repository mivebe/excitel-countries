    ...
    <tbody>
        {entries.map(entry =>
            <tr key={entry.code} {...longPressProps}>
                <td entryid={entry.code}>{entry.name}</td>
                <td entryid={entry.code}>{entry.capitalName}</td>
                <td entryid={entry.code}>{entry.region}</td>
                <td entryid={entry.code}>{entry.subregion}</td>
            </tr>)
        }
    </tbody>
</table>
